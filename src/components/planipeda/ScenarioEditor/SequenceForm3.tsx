// Nom du fichier: SequenceForm3.tsx
...
const SequenceForm: React.FC<SequenceFormProps> = ({
    ...
    const [sequenceData, setSequenceData] = useState<SequenceFormData>(
        initialSequenceData || {
            ...
            duree_estimee: null,
            prerequis: null,
            mots_cles: null, // AJOUTÉ : Champ mots_cles
        }
    );
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-white p-6 rounded-lg shadow-xl max-w-3xl mx-auto">
            ...
            <div className="relative p-4 bg-gray-50 rounded-lg border border-gray-200 shadow-sm">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <Label htmlFor="objectifs_specifiques" className="text-sm font-medium text-gray-700">Objectif général de la séquence</Label> {/* RENOMMÉ */}
                        <Input
                    ...
                    {/* NOUVEAU CHAMP: Mots-clés */}
                    <div>
                        <Label htmlFor="mots_cles" className="text-sm font-medium text-gray-700">Mots-clés</Label>
                        <Input
                            id="mots_cles"
                            name="mots_cles"
                            value={sequenceData.mots_cles || ""}
                            onChange={handleChange}
                            placeholder="Ex: programmation, algorithmes, variables (séparés par des virgules)"
                            className="h-10 text-base"
                        />
                    </div>
                </div>
