// src/components/planipeda/chapitreplanifier/PlanifierChapitreEditor.tsx 100% marche
 ...
 * Ce composant gère désormais UNIQUEMENT l'édition des activités maîtres. L'édition des séquences est désactivée.
 */
...
import SequenceBlock from './SequenceBlock'; // Importez le SequenceBlock mis à jour
...
// Importez EditActivityForm (maintenu pour l'édition des activités maîtres)
...
const PlanifierChapitreEditor: React.FC = () => {
  ...
  // États pour la modale d'édition d'activité maître (maintenus)
  ...
  // État pour déclencher le rafraîchissement des ActivityBlocks (maintenu)
  const [activityRefreshTrigger, setActivityRefreshTrigger] = useState(0);

  // NOUVEAU: État pour déclencher le rafraîchissement des SequenceBlocks
  ...
  // Fonction pour gérer l'ouverture de la modale d'édition d'activité maître (maintenue)
  ...
  // Callback appelé après la sauvegarde réussie de l'activité maître (maintenu)
  ...
  // NOUVEAU: Gère le rafraîchissement des Séquences après une action externe (non utilisée ici car mode affichage)
  // const handleMasterSequenceSaved = useCallback(() => {
  //     // Pas de modale d'édition pour la séquence ici, mais on pourrait déclencher un refresh si besoin
  ...
  return (
    <div className="p-6 bg-white shadow-lg rounded-lg max-w-4xl mx-auto my-8">
              ...
              if (item.type === 'sequence') {
                return (
                  <SequenceBlock
                    ...
                    sequenceRefreshTrigger={sequenceRefreshTrigger} // Passer le trigger de rafraîchissement
                  />
                );
      ...
      {/* Modale pour l'édition d'une activité maître (maintenue) */}
      <CustomModal
